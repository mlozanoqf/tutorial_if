...
```{r fig.cap="One-step binomial and Black-Scholes comparison."}
...
This section is based on @Hull section 13.1. The risk-neutral probability $p$ for the case of $rf=0.12$, $T=3/12$, $u=1.1$ and $d=0.9$:
...
$p\times(\$1) + (1-p)\times \$0$,
$0.6522727\times(\$1) + (1-0.6522727)\times \$0 = \$0.6522727$.
...
$p^*\times(\$1) + (1-p^*)\times \$0$,
$0.7040539\times(\$1) + (1-0.7040539)\times \$0 = \$0.7040539$.
