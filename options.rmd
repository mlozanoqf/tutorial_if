...
toc: yes
abstract: Options, stochastic processes and value at risk (VaR). This tutorial heavily relies on Hull textbook. I added some additional explanations and code for teaching purposes (literate programming). This is still a work in progress and it is under revision.
---
...
plot(K.seq, unlist(AEoptions[4,]) - unlist(AEoptions[2,]), type = "l", lwd = 2,
     main = "The value of being American.",
     xlab = "S_0",
     ylab = "Option premium for American options.")
abline(v = 52, lty = 2)
```
