...
```{r}
#| label: fig-wp1sfbtir
#| fig-cap: "Wiener process 10,000 steps from blue $z(0)=25$ to $z(T)=26.2$ in red."
plot(Time, z, type = "l",
...
```{r}
#| label: fig-owp1sipa2ritmat
#| fig-cap: "100 Wiener process 10,000 steps, initial price at 25, red is the mean at $T$."
...
```{r}
#| label: fig-aspwz
#| fig-cap: "A stochastic process with zoom."
set.seed(1)
delta_z <- rnorm(N, 0, 1) * dt^0.5 
z <- 25 + cumsum(delta_z)
...
```{r}
#| label: fig-wptrod
#| fig-cap: "Wiener process, the role of $\\Delta t$."
par(mfrow = c(2, 2), mai = c(0.4, 0.4, 0.4, 0.4))
par(pty = "s")
...
```{r}
#| label: fig-gwp
#| fig-cap: "Generalized Wiener process."
...
```{r}
#| label: fig-gwpzv
#| fig-cap: "Generalized Wiener process, zoom view."
# Figure 14.2 Zoom
...
```{r}
#| label: fig-gwpla
#| fig-cap: "Generalized Wiener process, lower a."
set.seed(123)
...
```{r}
#| label: fig-gwphb
#| fig-cap: "Generalized Wiener process, higher b."
set.seed(123)
...
```{r}
#| label: fig-cpxax
#| fig-cap: "Correlated processes x1 and x2."
...
<!-- ```{r fig.cap="It̫ process. This figure needs revision."} -->
<!-- # Figure 14.2 with It̫ process -->
<!-- TT <- 50 -->
<!-- N <- 200 -->
<!-- dt <- TT / N -->
<!-- Time <- seq(from = 0, to = TT, by = dt) -->
...
<!-- abline(0, 0) -->
<!-- abline(v = 0) -->
<!-- legend("topleft", legend = c("It̫ process",  -->
<!--                            "Stochastic drift", "Wiener process"), -->
<!--        col = c("black", "blue", "red"), lty = 1, bg = "white", lwd = 2) -->
<!-- ``` -->

<!-- This is a clear view of a typical It̫ process. Taken from Esteban Moro. -->

<!-- ```{r echo=FALSE, out.width='50%', fig.align="center", fig.cap="It̫ process."} -->
...
```{r}
#| label: fig-agbms1spp
#| fig-cap: "A geometric Brownian motion simulation: 100 stock price paths."
set.seed(10101010)
for(j in 1:100) {
  delta_S <- NULL 
...
```{r}
#| label: fig-agbms1spp2
#| fig-cap: "A geometric Brownian motion simulation: 1000 stock price paths."
